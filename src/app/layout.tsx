...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://frankenautoankauf24.de",
  },
  category: "Automotive",
};
...
const localBusinessData = {
  ...
  "@type": "LocalBusiness",
  "name": "Auto Ankauf Franken",
  "image": "https://frankenautoankauf24.de/brand/logo-light.png",
  "telephone": "+49-176-32333561",
  "email": "info@frankenautoankauf24.de",
  "address": {
    "@type": "PostalAddress",
  ...
  return (
    <html lang="de" className={`${geistSans.variable} ${geistMono.variable}`}>
      <head>
        ...
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-8B77QCJ58V"
